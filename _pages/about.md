...
**Applied Experience:** I've built production ML systems at Bank of America (risk stratification and churn prediction) and Zensar Technologies (agentic systems processing 167M+ records daily), gaining deep experience in end-to-end ML lifecycle, feature engineering, ensemble methods, model monitoring, and translating research into production-ready systems. I'm experienced in scaling ML infrastructure on GCP and implementing rigorous experimentation frameworks.
